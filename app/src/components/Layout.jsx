...
const NAV_ITEMS = [
  ...
  { path: '/import-progress', label: 'Import Progress', emoji: '📥' },
];
  ...
  return (
    <div ref={ref} style={{ position: 'relative', flexShrink: 0 }}>
      <button onClick={() => setOpen(o => !o)} style={{
        ...
        <span style={{ fontSize: '0.85rem', color: 'var(--primary)', marginLeft: 2, fontWeight: 700 }}>▾</span>
      </button>
...
export default function Layout({ children }) {
  ...
  // When a child is active, show their name + a subtle 'via Parent' label
  // in the nav pill so the current context is always visible
